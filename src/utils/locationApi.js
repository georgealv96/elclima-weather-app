...
export function create(data) {
  return fetch(BASE_URL, {
    ...
    throw new Error('Something went wrong in create Location') // this will go to the catch block when we call the function in the AddPostPuppyForm
    // handleSubmit
  })
}
...
export function getAllLocations() {
  return fetch(BASE_URL, {
    ...
    throw new Error(
      'Something went wrong in getAllLocations, check the terminal!'
    )
  })
}
